  ...
  return (
    <TextSection>
      ...
      <ul>
        ...
        <li>
          WebRTC data from your browser such as: ICE candidate descriptions and
      ...
      <p>
        For clients that support end-to-end encryption, the WebRTC data and file
        metadata will be encrypted and unknown to the service.
      </p>
      <p>
      ...
      <p>
        ...
        the client name in local storage, this can't and won't be used to track
        users.
      </p>
      <p>
        Your IP address may be shared with the other device involved in the file
        transfer once you accept a transfer or your transfer is accepted. This
        data is used to create a WebRTC connection.
      </p>
    </TextSection>
  );
};
